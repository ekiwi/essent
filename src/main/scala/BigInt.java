...
public class BigInt extends Number implements Comparable<BigInt> {
    ...
    public static void add(BigInt rd, final BigInt rs1, final BigInt rs2) {
        if (sign == a.sign) {
            addMag(a.dig, a.len);
            return;
        }
    ...
    public void add(BigInt rd, BigInt rs1, long rs2) {

    }

    public void add(BigInt rd, long rs1, BigInt rs2) {

    }

    public void add(BigInt rd, long rs1, long rs2) {
